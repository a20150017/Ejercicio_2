alert("Bienvenido a la página de JavaScript, completa el cuestionario (coloca la letra de tus respuestas en mayúsculas");
var nom = prompt("Ingrese su nombre y apellido");
var res1 = prompt("¿Cómo se le llama al primer día de la Primavera?\nA: Primer Día de la Primavera\nB: Equinocio de Primavera\nC: Equinocio de Invierno");
if(res1 == "B"){
    res1 = 25;
}else{
    res1 = 0;
